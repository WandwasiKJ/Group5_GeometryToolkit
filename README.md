...
A design office needs a small software toolkit for everyday rectangular shapes used in layout calculations.
A rectangle is described by a length and a width. From those dimensions the toolkit must provide the area and the perimeter, and must indicate whether the rectangle is actually a square (length equal to width).
